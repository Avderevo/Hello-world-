...
import os
import django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'activity_rating.settings')
django.setup()

import matplotlib as mpl
import matplotlib.pyplot as plt

from runrun.models import Activities
import datetime
...
def plotl(day, r):
    ...
    for i in range(len(rec)):
        ...
        fig.savefig('./static/runrun/images/barshoris'+r[i]+'.png')
